 ...
 */
export function Detail({ workspace }: DetailProps): JSX.Element {
    ...
    <main className="min-w-0 flex-1 overflow-y-auto px-10 pt-7.5 pb-10">
      <div className="flex items-start justify-between gap-6">
        ...
        <div className="flex shrink-0 items-center gap-2">
          <button
            className="flex h-8 w-8 items-center justify-center rounded-md border border-border-strong bg-transparent text-[15px] text-text-muted hover:bg-bg-hover hover:text-text"
            type="button"
          >
